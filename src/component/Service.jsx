const Service = () => {
  return (
    <div id="services" className="lg:p-20 p-5 w-full bg-black ">
      ...
      <div>
        ...
        <div className="card-body lg:w-[600px] w-100% bg-stone-900 text-white mt-10 lg:ml-10 p-5 ">
          ...
          <div className="card-body lg:w-[600px] w-100% bg-stone-900 text-white lg:mt-10 p-5 ">
