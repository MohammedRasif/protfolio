      ...
      <div className="flex   mt-10">
        ...
        <div className="w-1/2 ml-20 hidden lg:block">
          <div className="flex space-x-10">
            <div>
              <label className="text-white ml-5 mb-2 block text-lg">
                First Name <span className="text-amber-400">*</span>
              </label>
              <input
                type="text"
                className="border-2 w-full rounded-full px-14 py-3 text-amber-400 border-amber-400 bg-stone-800 focus:outline-none"
              />
            </div>
            <div>
              <label className="text-white ml-5 mb-2 block text-lg">
              ...
              <input
                type="text"
                className="border-2 w-full rounded-full px-14 py-3 ml-2 text-amber-400 border-amber-400 bg-stone-800 focus:outline-none"
              />
            </div>
          </div>
          <div className="mt-5">
            ...
            <input
              type="email"
              className="border-2 w-full rounded-full px-8 py-3 text-amber-400 border-amber-400 bg-stone-800 focus:outline-none"
            />
          </div>
          <div className="mt-5">
            <label className="text-white ml-5 mb-2 block text-lg">
            ...
            <textarea className="border-2 w-full rounded-3xl px-8 py-4 text-amber-400 border-amber-400 bg-stone-800 h-36 resize-none focus:outline-none" />
          </div>
          <button className="btn glass bg-amber-500 text-black mt-5 w-full text-2xl font-abc font-bold hover:text-amber-400">
            Sent Me
          </button>
        </div>
      </div>
