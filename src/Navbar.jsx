    ...
    return (
        ...
        <div>
            ...
            <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                ...
                <button className=' hidden lg:inline-block font-bold text-xl mr-3 px-6 py-1 border-orange-400 border-x-2 border-y-2 rounded-3xl text-white'>Hire Me</button>
